...
import com.phuc.tictactoe.servlet.server.Server;
...
public class ServerResponse implements Protocol {
    ...
    public ServerResponse(boolean isFinished, String board, String message, int nonce, long timestamp) {
        ...
        this.hashBoard = ServerHash.generateHashBoard(board);
        this.nonce = nonce;
        this.hashNonce = ServerHash.generateHashNonce(nonce);
        this.timestamp = timestamp;
        this.hashTimestamp = ServerHash.generateHashTimestamp(timestamp);
    }
